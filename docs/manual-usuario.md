...
![Pantalla de inicio: cargá tus preguntas desde un archivo o un enlace.](images/manual/01-cargar.png)
...
![Zona de respuestas y navegación: números para saltar de pregunta y controles para avanzar o entregar.](images/manual/03-responder.png)
...
![Guardado del progreso: guardá el archivo actualizado y cargalo cuando quieras continuar.](images/manual/06-guardar.png)
...
![Parte inferior del examen en el celular: opciones y controles de navegación.](images/manual/07-mobile.png)
